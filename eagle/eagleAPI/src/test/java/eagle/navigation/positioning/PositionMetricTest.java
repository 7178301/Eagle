...
public class PositionMetricTest {
    ...
    public void testAddAndCompare() throws Exception {
        ...
        Position output = pos.add(new PositionMetricDisplacement(0, 1000, 0, new Angle(0), new Angle(0), new Angle(0)));
        ...
        PositionMetricDisplacement posDisp = ((PositionMetric)output).compare(pos);
        assertEquals("Wrong displacement", true, Math.abs(posDisp.getLongitude() - 1000) < 1);



        output = pos.add(new PositionMetricDisplacement(0, -1000, 0, new Angle(0), new Angle(0), new Angle(0)));
        ...
        output = pos.add(new PositionMetricDisplacement(1000, 0, 0, new Angle(0), new Angle(0), new Angle(0)));
    ...
    public void testCompare() throws Exception {
        ...
        PositionMetricDisplacement posDisp = pos1.compare(pos2);


        assertEquals("Wrong displacement", new PositionMetricDisplacement(0, 0, 0, new Angle(0), new Angle(0), new Angle(0)), posDisp);
    }
    ...
    public void testAdd(){
        ...
        PositionMetricDisplacement dp = new PositionMetricDisplacement(1.23, 2.34, 3.45,new Angle(0),new Angle(0),new Angle(0));
